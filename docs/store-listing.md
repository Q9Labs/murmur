# Murmur store listing draft

Replaces the current fastlane metadata copy. Two corrections baked in: the live listing claims 15 languages including Urdu, Turkish, and Indonesian, but the language registry ships 13 and none of those three — this draft says 13 and lists them. The App Store keywords field also drops `urdu` for the same reason. Category: move primary to Travel (Utilities secondary), per `docs/growth-and-aso-strategy.md`.
