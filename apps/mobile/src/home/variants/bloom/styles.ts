...
export const styles = StyleSheet.create({
  ...
  speakerCone: {
    ...
    borderBottomWidth: 7,
    borderLeftColor: bloomColors.plum,
    borderLeftWidth: 8,
  ...
  speakerSlash: {
    backgroundColor: bloomColors.plum,
    borderColor: "rgba(255, 253, 249, 0.90)",
    borderRadius: 999,
    borderWidth: 1,
    height: 24,
    left: 11,
  ...
  speakerWaveLarge: {
    borderBottomColor: bloomColors.plum,
    borderBottomWidth: 1.7,
    borderLeftColor: "transparent",
    borderLeftWidth: 1.7,
    borderRadius: 999,
    borderRightColor: bloomColors.plum,
    borderRightWidth: 1.7,
    borderTopColor: bloomColors.plum,
    borderTopWidth: 1.7,
    height: 20,
    left: 12,
    position: "absolute",
