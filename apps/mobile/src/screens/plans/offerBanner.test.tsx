...
describe("personal offer banner", () => {
  it("counts down in hours, minutes and seconds past a day", () => {
    expect(formatCountdown(47 * 3_600_000 + 5 * 60_000 + 9_400, en)).toBe("47:05:09");
  ...
  it("speaks the time left without seconds", () => {
    expect(spokenCountdown(47 * 3_600_000 + 5 * 60_000, en)).toBe("47 hours 5 minutes");
    expect(spokenCountdown(3_600_000, en)).toBe("1 hour");
    expect(spokenCountdown(30_000, en)).toBe("1 minute");
  });
