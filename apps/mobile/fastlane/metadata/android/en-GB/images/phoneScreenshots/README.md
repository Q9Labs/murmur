...
A future capture pass should add a longer Continuous Mode session from the current default interface before store publication. The generated composition may establish a verified use case, but the underlying product screen must remain a real capture.
