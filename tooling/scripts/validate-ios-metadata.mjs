...
import { createFailureCollector, iosScreenshotSpec, validatePngDirectory } from "./store-screenshot-validation.mjs";
...
assert(
  /7 free translation minutes/i.test(reviewNotes),
